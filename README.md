- [1. Learning JQ](#1-learning-jq)
  - [1.1. Starting with JSON Basics](#11-starting-with-json-basics)
    ...
    - [1.1.2. JSON manipulation with JQ](#112-json-manipulation-with-jq)
      ...
      - [1.1.2.3. Operations and Transformations](#1123-operations-and-transformations)
      - [1.1.2.4. JQ Advanced Functions](#1124-jq-advanced-functions)
    - [1.1.3. Practical Uses that fits Networking tasks](#113-practical-uses-that-fits-networking-tasks)
      - [1.1.3.1. Processing Devices Configurations](#1131-processing-devices-configurations)
      - [1.1.3.2. Reports Creation](#1132-reports-creation)
    - [1.1.4. Advanced JSON topics and best practices](#114-advanced-json-topics-and-best-practices)
      - [1.1.4.1. JSON in Automation](#1141-json-in-automation)
      - [1.1.4.2. Creating MD using JQ](#1142-creating-md-using-jq)
      - [1.1.4.3. Iterating on JSON Arrays with JQ](#1143-iterating-on-json-arrays-with-jq)
      - [1.1.4.4. Accessing to multiple fields](#1144-accessing-to-multiple-fields)
      - [1.1.4.5. Filtering elements before iterating (ex: only `active`)](#1145-filtering-elements-before-iterating-ex-only-active)
      - [1.1.4.6. Iterating on nested objects (Key-Value pairs)](#1146-iterating-on-nested-objects-key-value-pairs)
...
#### 1.1.2.3. Operations and Transformations
...
```
### 1.1.3. Practical Uses that fits Networking tasks

#### 1.1.3.1. Processing Devices Configurations
...
### 1.1.4. Advanced JSON topics and best practices

#### 1.1.4.1. JSON in Automation

#### 1.1.4.2. Creating MD using JQ
...
#### 1.1.4.3. Iterating on JSON Arrays with JQ
...
#### 1.1.4.4. Accessing to multiple fields
...
#### 1.1.4.5. Filtering elements before iterating (ex: only `active`)
...
#### 1.1.4.6. Iterating on nested objects (Key-Value pairs)
...
```
##### 1.1.4.6.1. Iterating on key and pairs
...
```
##### 1.1.4.7.1. Iterating on devices and interfaces
